...
export class MessagesController {
  ...
  @Get() findAll(@Query() q: QueryMessagesDto, @CurrentUser() u: UserEntity) { return this.svc.findAll(q, u); }
  @Patch('read-all/:applicationId') markAllRead(@Param('applicationId', ParseIntPipe) id: number, @CurrentUser() u: UserEntity) { return this.svc.markAllRead(id, u); }
  ...
  @Patch(':id') update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateMessageDto, @CurrentUser() u: UserEntity) { return this.svc.update(id, dto, u); }
}
