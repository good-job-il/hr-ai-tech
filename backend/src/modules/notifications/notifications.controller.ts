...
export class NotificationsController {
  ...
  @Post() @Roles(...NOTIFICATION_CREATE_ROLES) @HttpCode(HttpStatus.CREATED) create(
    @Body() dto: CreateNotificationDto,
  ) {
    return this.svc.create(dto)
  }

  @Patch(":id/read") markRead(@Param("id", ParseIntPipe) id: number, @CurrentUser() u: UserEntity) {
    return this.svc.markRead(id, u)
  }

  @Patch("read-all") markAllRead(@CurrentUser() u: UserEntity) {
    return this.svc.markAllRead(u.email)
  }
