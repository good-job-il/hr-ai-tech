...
export class ApplicationsService {
  constructor(
    ...
    private readonly timelineRepo: Repository<ApplicationTimelineEntity>,
    ...
    return this.create(
      {
        ...
        recruitment_manager_id:
          candidate.recruitment_manager_id ??
    ...
    if (statusChanged) {
      await this.notificationsService
        .create({
          ...
          organization_id: app.organization_id,
          type: ["phone_interview", "employer_interview"].includes(dto.status)
            ? "interview_scheduled"
            : "new_application",
