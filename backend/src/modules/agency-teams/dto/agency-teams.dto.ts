...
export class CreateAgencyTeamDto extends createZodDto(
  z.object({
...
export class UpdateAgencyTeamDto extends createZodDto(
  z.object({
...
export class InviteAgencyMemberDto extends createZodDto(
  z.object({
...
export class UpdateAgencyMemberDto extends createZodDto(
  z.object({
...
export class AcceptAgencyInvitationDto extends createZodDto(
  z.object({
