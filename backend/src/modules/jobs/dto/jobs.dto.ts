...
export const CreateJobSchema = z.object({
  ...
  state: z.enum(["draft", "open", "on_hold", "filled", "closed"]).optional().default("open"),
...
export const QueryJobsSchema = z.object({
  ...
  sort: z
    .enum(["created_date", "updated_date", "views", "title", "company"])
  ...
  state: z.enum(["draft", "open", "on_hold", "filled", "closed"]).optional(),
