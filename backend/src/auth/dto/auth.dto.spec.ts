...
describe('RegisterSchema', () => {
  ...
  it.each(['admin', 'recruiter', 'team_manager', 'recruitment_manager', 'hr_manager', 'internal_recruiter'])(
    'rejects browser-authored privileged role %s',
    role => expect(() => RegisterSchema.parse({ ...valid, role })).toThrow(),
  );
