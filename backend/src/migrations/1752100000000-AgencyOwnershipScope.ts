...
export class AgencyOwnershipScope1752100000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await this.addColumnIfMissing(queryRunner, 'jobs', 'team_manager_id', 'INT NULL AFTER recruiter_id');
    await this.addColumnIfMissing(queryRunner, 'jobs', 'recruitment_manager_id', 'INT NULL AFTER team_manager_id');
    ...
    if (recruiterNeedsConversion) {
      await this.addColumnIfMissing(queryRunner, 'interviews', 'n_recruiter_id', 'INT NULL AFTER recruiter_id');
    }
    ...
    await this.addColumnIfMissing(queryRunner, 'interviews', 'recruitment_manager_id', 'INT NULL AFTER team_manager_id');
    ...
    await this.addIndexIfMissing(queryRunner, 'interviews', 'IDX_interviews_recruiter', 'recruiter_id');
    await this.addIndexIfMissing(queryRunner, 'interviews', 'IDX_interviews_team_manager', 'team_manager_id');

    await this.addColumnIfMissing(queryRunner, 'candidate_import_batches', 'organization_id', 'INT NULL AFTER id');
    await this.addColumnIfMissing(queryRunner, 'candidate_import_batches', 'team_manager_id', 'INT NULL AFTER recruiter_id');
    await this.addColumnIfMissing(queryRunner, 'candidate_import_batches', 'recruitment_manager_id', 'INT NULL AFTER team_manager_id');
    await this.addIndexIfMissing(queryRunner, 'candidate_import_batches', 'IDX_import_batches_org', 'organization_id');
    await this.addIndexIfMissing(queryRunner, 'candidate_import_batches', 'IDX_import_batches_team_manager', 'team_manager_id');
    await queryRunner.query(`
