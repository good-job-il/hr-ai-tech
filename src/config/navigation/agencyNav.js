...
export const AGENCY_ADMIN_NAV = [
...

  {
    ...
    children: [
      ...
      { id: 'agency-settings-roles', labelKey: 'nav.agency.roles', route: '/agency/settings/roles' },
      { id: 'agency-settings-billing', labelKey: 'nav.agency.billing', route: '/agency/settings/billing' },
      { id: 'agency-settings-integrations', labelKey: 'nav.agency.integrations', route: '/agency/settings/integrations' },
    ],
  },
];
...
export const AGENCY_RECRUITER_NAV = [
  { id: 'rec-dashboard', labelKey: 'nav.recruiter.dashboard', route: '/agency/recruiter/dashboard', icon: LayoutDashboard },
  {
    ...
    children: [
      ...
      { id: 'rec-candidates-active', labelKey: 'nav.recruiter.activeCandidates', route: '/agency/recruiter/candidates/active' },
      { id: 'rec-candidates-pipeline', labelKey: 'nav.recruiter.pipelineCandidates', route: '/agency/recruiter/candidates/pipeline' },
    ],
  },
  { id: 'rec-jobs', labelKey: 'nav.recruiter.jobs', route: '/agency/recruiter/jobs', icon: Briefcase },
  { id: 'rec-crm', labelKey: 'nav.recruiter.crm', route: '/agency/recruiter/crm', icon: ContactRound },
  { id: 'rec-pipeline', labelKey: 'nav.recruiter.pipeline', route: '/agency/recruiter/pipeline', icon: Kanban },
  { id: 'rec-ai', labelKey: 'nav.recruiter.aiMatching', route: '/agency/recruiter/ai-matching', icon: Sparkles },
];
...
export const AGENCY_TEAM_MANAGER_NAV = [
  ...
  { id: 'tm-import', labelKey: 'nav.teamManager.importCandidates', route: '/agency/team/import', icon: FileText },
  { id: 'tm-reports', labelKey: 'nav.teamManager.reports', route: '/agency/team/reports', icon: PieChart },
];
