...
export const CANDIDATE_NAV = [
  {
    ...
    labelKey: "nav.candidate.dashboard",
    route: "/candidate/dashboard",
    icon: LayoutDashboard,
  },
  {
    id: "candidate-profile",
    labelKey: "nav.candidate.profile",
    route: "/candidate/profile",
    icon: Users,
  },
  {
    id: "candidate-jobs",
    labelKey: "nav.candidate.jobs",
    ...
    children: [
      ...
      {
        id: "saved",
        labelKey: "candidate.savedJobs.title",
        route: "/candidate/jobs/saved",
        badge: 5,
      },
    ],
  },
  {
    ...
    labelKey: "nav.candidate.applications",
  ...
  },
  {
    ...
    labelKey: "nav.candidate.interviews",
    route: "/candidate/interviews",
    icon: Eye,
  },
  {
    id: "candidate-messages",
    labelKey: "nav.candidate.messages",
