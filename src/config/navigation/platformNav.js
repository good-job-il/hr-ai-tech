import {
  LayoutDashboard, Building2, CreditCard, ShoppingCart, BarChart3,
  ShieldCheck, Settings, Users, Zap, Activity, FileText, Globe,
...
export const PLATFORM_NAV = [
...

  {
    ...
    children: [
      ...
      { id: 'billing-invoices', labelKey: 'nav.platform.invoices', route: '/platform/billing/invoices' },
      { id: 'billing-flags', labelKey: 'nav.platform.flags', route: '/platform/billing/flags' },
    ],
  },
  {
    id: 'platform-marketplace', labelKey: 'nav.platform.candidatePool', route: '/platform/marketplace', icon: ShoppingCart,
    children: [
      { id: 'market-candidates', labelKey: 'nav.platform.availableCandidates', route: '/platform/marketplace/candidates' },
      { id: 'market-exposure', labelKey: 'nav.platform.poolExposure', route: '/platform/marketplace/exposure' },
    ],
  },

  {
    ...
    children: [
      ...
      { id: 'analytics-parsing', labelKey: 'nav.platform.parsingImports', route: '/platform/analytics/parsing' },
      { id: 'analytics-integrations', labelKey: 'nav.platform.integrationsHealth', route: '/platform/analytics/integrations' },
    ],
  },

  {
    ...
    children: [
      ...
      { id: 'security-permissions', labelKey: 'nav.platform.permissionChanges', route: '/platform/security/permissions' },
      { id: 'security-deleted', labelKey: 'nav.platform.deletedRecords', route: '/platform/security/deleted' },
      { id: 'security-impersonation', labelKey: 'nav.platform.impersonationLog', route: '/platform/security/impersonation' },
      { id: 'security-suspicious', labelKey: 'nav.platform.suspiciousActivity', route: '/platform/security/suspicious' },
    ],
  },

  {
    ...
    children: [
      ...
      { id: 'settings-permissions', labelKey: 'nav.platform.globalPermissions', route: '/platform/settings/permissions' },
      { id: 'settings-ai', labelKey: 'nav.platform.aiSettings', route: '/platform/settings/ai' },
      { id: 'settings-parsing', labelKey: 'nav.platform.parsingRules', route: '/platform/settings/parsing' },
      { id: 'settings-roles', labelKey: 'nav.platform.roleTemplates', route: '/platform/settings/roles' },
    ],
  },
  {
    id: 'platform-impersonation', labelKey: 'nav.platform.impersonation', route: '/platform/impersonation', icon: Eye,
    children: [
      { id: 'imp-org', labelKey: 'nav.platform.loginAsOrg', route: '/platform/impersonation/org' },
      { id: 'imp-recruiter', labelKey: 'nav.platform.loginAsRecruiter', route: '/platform/impersonation/recruiter' },
      { id: 'imp-support', labelKey: 'nav.platform.supportMode', route: '/platform/impersonation/support' },
    ],
  },
];
