    ...
    <PlatformPageShell className="text-left" dir="ltr">
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
          {kpis.map((item) => (
            <PlatformStatCard key={item.label} {...item} loading={loading} meta="from last month" />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.65fr_1fr]">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dashboardData} margin={{ top: 5, right: 8, left: -22, bottom: 0 }}>
                  ...
                  <Area
                    ...
                    stroke="#cf45c4"
                    strokeWidth={2.5}
                    fill="url(#platformOrgsGradient)"
                    dot={{ r: 3, fill: "#cf45c4", strokeWidth: 0 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          ...
          <PlatformCard className="min-h-[340px] p-5 sm:p-6">
            ...
            {loading ? (
              ...
              <div className="mt-5">
                <PlatformEmptyState>No organization data yet</PlatformEmptyState>
              </div>
            )}
          </PlatformCard>
        </div>
                    ...
                    <Link
                      ...
                      to={
                        organization.org_type === "staffing_agency"
                          ? "/platform/organizations/staffing"
                          : "/platform/organizations/companies"
                      }
        ...
        <PlatformCard className="overflow-hidden">
          <div className="grid grid-cols-2 divide-x divide-y divide-slate-100 sm:grid-cols-3 sm:divide-y-0 xl:grid-cols-6">
            {[
              ...
              {
                icon: CircleAlert,
                value: stats.suspended?.length ?? 0,
                label: "Suspended",
                tone: "text-rose-600 bg-rose-50",
              },
              {
                icon: Building2,
                value: stats.orgs?.length ?? 0,
                label: "Organizations",
