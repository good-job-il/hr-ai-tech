      ...
      <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
        <div className="max-w-[1200px] mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            {companies.length > 0 && <p className="text-gray-500 text-sm mt-2">{companies.length} חברות המעניקות משרות</p>}
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              {companies.map((company) => (
                ...
                >
                  ...
                  {company.industry && <p className="text-sm text-gray-600 mt-1">{company.industry}</p>}
                  <div className="mt-4 pt-4 border-t border-gray-100 w-full">
                    <p className={`text-lg font-bold ${(company.job_count || 0) > 0 ? 'text-hhblue' : 'text-gray-400'}`}>
