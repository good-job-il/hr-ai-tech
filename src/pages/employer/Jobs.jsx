      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">{jobs.length} active jobs</p>
          </div>
          <button
            onClick={handleNew}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-xs text-gray-500">
                      ...
                      <Send className="w-3.5 h-3.5" /> {job.applications_count || 0} applications
                    </div>
                    <div className="flex items-center gap-2 mt-2">
                       ...
                       {job.is_closed && (
                         <span className="px-2 py-1 bg-red-50 text-red-700 rounded text-xs font-medium">Closed</span>
                       )}
                     </div>
                       ...
                       return (
                         <div className="flex items-center gap-2 text-xs mt-3 pt-3 border-t border-gray-100">
                           ...
                           {plan.warranty_period_days && (
                             <span className="text-gray-700 font-medium">{plan.warranty_period_days} days</span>
                           )}
                         </div>
                       );
                     })()}
