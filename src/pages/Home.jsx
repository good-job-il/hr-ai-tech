  ...
  return (
    <div className={`${glassCard} w-[360px] p-7 relative overflow-hidden`}>
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          <h3 className="text-[#0F172A] text-xl font-extrabold">{isRtl ? 'דניאל כהן' : 'Daniel Cohen'}</h3>
          <p className="text-[#48556A] font-semibold">Full Stack Developer</p>
          <p className="text-[#6C4DFF] text-sm font-semibold mt-1">{isRtl ? 'תל אביב, ישראל' : 'Tel Aviv, Israel'}</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {['React', 'Node.js', 'TypeScript', 'PostgreSQL', 'AWS'].map((tag) => (
          <span key={tag} className="px-3 py-1.5 rounded-full bg-[#F0F4FF] text-[#5B4FEA] text-xs font-bold">
            {tag}
          </span>
        ))}
      </div>
      ...
      <div className="space-y-4 border-t border-[#E6EEFF] pt-5">
        <div className="flex items-start justify-between gap-5">
          ...
          <div className="text-right">
            <p className="text-[#0F172A] font-extrabold">{isRtl ? 'ניסיון תעסוקתי' : 'Work Experience'}</p>
        ...
        <div className="flex items-start justify-between gap-5">
          ...
          <div className="text-right">
            ...
            <p className="text-[#64748B] text-sm">{isRtl ? 'B.Sc במדעי המחשב' : 'B.Sc Computer Science'}</p>
            <p className="text-[#94A3B8] text-xs">{isRtl ? 'אוניברסיטת תל אביב' : 'Tel Aviv University'}</p>
          </div>
        </div>
      </div>
    </div>
...
function AIOrb() {
  return (
    <div style={{ position: 'relative', width: 420, height: 420, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'radial-gradient(circle, rgba(108,77,255,0.22) 0%, rgba(47,128,255,0.12) 45%, transparent 72%)' }} />
      <div style={{ position: 'absolute', width: 400, height: 400, borderRadius: '50%', border: '1px solid rgba(164,196,255,0.28)' }} />
      <div style={{ position: 'absolute', width: 350, height: 350, borderRadius: '50%', border: '1px solid rgba(164,196,255,0.22)' }} />
      <div style={{ position: 'absolute', width: 300, height: 300, borderRadius: '50%', border: '1px solid rgba(164,196,255,0.18)' }} />
      <div style={{ position: 'absolute', width: 260, height: 260, borderRadius: '50%', background: 'radial-gradient(circle at 38% 32%, rgba(255,255,255,0.22) 0%, transparent 42%), linear-gradient(145deg, #6C3FDD 0%, #4F7CFF 40%, #06B6D4 100%)', boxShadow: '0 0 0 1px rgba(255,255,255,0.18), 0 0 60px rgba(108,77,255,0.55), 0 0 120px rgba(79,124,255,0.3), 0 30px 80px rgba(79,124,255,0.3)', overflow: 'hidden' }}>
        <svg viewBox="0 0 260 260" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', opacity: 0.5 }}>
          <defs><linearGradient id="nl1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#fff" stopOpacity="0.8" /><stop offset="100%" stopColor="#7DE3FF" stopOpacity="0.3" /></linearGradient></defs>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <svg viewBox="0 0 120 148" width="108" height="133" style={{ filter: 'drop-shadow(0 0 20px rgba(165,243,252,0.7)) drop-shadow(0 0 8px rgba(255,255,255,0.4))' }}>
            <defs>
              <linearGradient id="hf2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="rgba(255,255,255,0.35)" /><stop offset="100%" stopColor="rgba(167,243,252,0.2)" /></linearGradient>
              <linearGradient id="cl2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#ffffff" stopOpacity="0.95" /><stop offset="100%" stopColor="#A5F3FC" stopOpacity="0.7" /></linearGradient>
            </defs>
            <rect x="44" y="110" width="32" height="28" rx="6" fill="url(#hf2)" stroke="rgba(255,255,255,0.4)" strokeWidth="1" />
            <path d="M60 8 C30 8 16 32 16 58 C16 84 26 100 42 112 L42 122 L78 122 L78 112 C94 100 104 84 104 58 C104 32 90 8 60 8 Z" fill="url(#hf2)" stroke="rgba(255,255,255,0.55)" strokeWidth="1.5" />
            <rect x="8" y="52" width="9" height="20" rx="4.5" fill="rgba(255,255,255,0.22)" stroke="rgba(255,255,255,0.4)" strokeWidth="1" />
            <rect x="103" y="52" width="9" height="20" rx="4.5" fill="rgba(255,255,255,0.22)" stroke="rgba(255,255,255,0.4)" strokeWidth="1" />
            <line x1="34" y1="52" x2="57" y2="52" stroke="url(#cl2)" strokeWidth="1.2" strokeLinecap="round" opacity="0.85" />
            <line x1="63" y1="52" x2="86" y2="52" stroke="url(#cl2)" strokeWidth="1.2" strokeLinecap="round" opacity="0.85" />
            <line x1="60" y1="40" x2="60" y2="78" stroke="url(#cl2)" strokeWidth="1.2" strokeLinecap="round" opacity="0.75" />
            <line x1="36" y1="66" x2="84" y2="66" stroke="url(#cl2)" strokeWidth="1" strokeLinecap="round" opacity="0.65" />
            {[[60,52],[60,66],[42,56],[78,56],[42,76],[78,76],[60,40],[60,78]].map(([cx,cy],i) => (
            ...
            <path d="M50 88 Q60 94 70 88" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="1.2" strokeLinecap="round" />
          </svg>
        </div>
      </div>
      <div style={{ position: 'absolute', top: 60, right: 50, width: 12, height: 12, borderRadius: '50%', background: '#A5F3FC', boxShadow: '0 0 14px rgba(165,243,252,0.9)' }} />
      <div style={{ position: 'absolute', bottom: 65, left: 48, width: 8, height: 8, borderRadius: '50%', background: '#C4B5FD', boxShadow: '0 0 12px rgba(196,181,253,0.9)' }} />
      <div style={{ position: 'absolute', top: 80, left: 70, width: 7, height: 7, borderRadius: '50%', background: '#93C5FD', boxShadow: '0 0 10px rgba(147,197,253,0.8)' }} />
      <div style={{ position: 'absolute', bottom: 85, right: 65, width: 14, height: 14, borderRadius: '50%', background: 'rgba(255,255,255,0.18)', border: '1px solid rgba(255,255,255,0.4)', backdropFilter: 'blur(4px)' }} />
    </div>
  );
}
...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F7FBFF]" style={{ minHeight: 820 }}>
      ...
      <div className="relative max-w-[1500px] mx-auto px-8 py-16 grid grid-cols-1 lg:grid-cols-[35%_30%_35%] gap-10 items-center" style={{ minHeight: 820 }} dir={isRtl ? 'rtl' : 'ltr'}>
        <div className={isRtl ? 'text-right lg:order-1' : 'text-left lg:order-1'}>
          <div className="inline-flex items-center gap-2 rounded-full border border-[#D8E4FF] bg-white/75 backdrop-blur-xl px-5 py-2.5 text-[#6C4DFF] font-bold shadow-sm mb-8">
            ...
            {isRtl ? 'פלטפורמת הגיוס המובילה AI בישראל' : "Israel's Leading AI Recruitment Platform"}
          </div>

          <h1 className="text-[76px] leading-[0.98] font-black tracking-tight text-[#0F172A] mb-8">
            {isRtl ? (
              <>הקריירה שלך<br /><span className={gradientText}>מתחילה כאן.</span></>
            ) : (
              <>Your career<br /><span className={gradientText}>starts here.</span></>
            )}
          </h1>
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              {['👩🏻', '👨🏽', '👩🏼', '👨🏻'].map((a, i) => (
                <div key={i} className="w-12 h-12 rounded-full bg-white border-4 border-white shadow-md flex items-center justify-center text-xl">{a}</div>
              ))}
              <div className="w-12 h-12 rounded-full bg-white border-4 border-white shadow-md flex items-center justify-center text-[#6C4DFF] font-black">+</div>
            </div>
            <p className="text-[#64748B] font-semibold">
              {isRtl ? 'אלפי מועמדים כבר מצאו את המקום שלהם' : 'Thousands of candidates have already found their place'}
            </p>
          </div>
        </div>
  ...
  return (
    <section className="relative bg-white" style={{ padding: '80px 0' }}>
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <h2 style={{ fontSize: 52, fontWeight: 900, lineHeight: 1.1, color: '#0F172A', textAlign: 'center', marginBottom: 48 }}>
          {isRtl
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          {items.map((item) => (
            <div key={item.title} className={`${glassCard} p-7 min-h-[240px] hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(108,77,255,0.16)] transition`}>
              <div className="flex justify-between items-start mb-6">
                ...
                {item.badge && (
                  <span className="px-3 py-1 rounded-full bg-[#6C4DFF] text-white text-xs font-bold">{item.badge}</span>
                )}
              </div>
...
function SearchSection() {
  ...
  const tags = isRtl
    ? ['מפתח Frontend', 'מפתח Full Stack', 'מפתח Backend', 'DevOps', 'אנליסט נתונים', 'מעצב UI/UX', 'מוצר', 'שיווק דיגיטלי']
    : ['Frontend Developer', 'Full Stack Developer', 'Backend Developer', 'DevOps', 'Data Analyst', 'UI/UX Designer', 'Product', 'Digital Marketing'];

  return (
    <section className="bg-[#F6FBFF]" style={{ padding: '80px 0' }}>
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <h2 style={{ fontSize: 48, fontWeight: 900, lineHeight: 1.1, color: '#0F172A', textAlign: 'center', marginBottom: 32 }}>
        ...
        <div className={`${glassCard} p-9`}>
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-7">
            {tags.map((tag) => (
              <button key={tag} onClick={() => { setQ(tag); navigate(`/jobs?search=${encodeURIComponent(tag)}`); }} className="px-5 py-2 rounded-full bg-white border border-[#DCE8FF] text-[#6C4DFF] font-bold shadow-sm hover:shadow-md transition">
                {tag}
              </button>
            ))}
          </div>
      ...
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
          <div className={`${glassCard} p-8 bg-gradient-to-br from-white to-[#F3F0FF]`}>
            ...
            <h2 style={{ fontSize: 44, fontWeight: 900, lineHeight: 1.1, color: '#0F172A', marginBottom: 16 }}>
            ...
            <Link to="/register" className="h-12 px-6 rounded-2xl bg-gradient-to-l from-[#2F80FF] to-[#8B5CF6] text-white font-bold inline-flex items-center">
...
function StatsSection() {
  ...
  return (
    <section className="bg-[#F6FBFF]" style={{ padding: '60px 0' }}>
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <div className={`${glassCard} grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[#DCE8FF]`}>
          {stats.map((s) => {
            const Icon = s.icon;
            return (
...
function HowItWorks() {
  ...
  const steps = [
    {
      ...
      text: isRtl ? 'מעלים קורות חיים וממלאים פרטים בסיסיים.' : 'Upload your resume and fill in basic details.',
    },
    {
      icon: Brain,
  ...
  return (
    <section className="bg-white" style={{ padding: '80px 0' }}>
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <h2 style={{ fontSize: 48, fontWeight: 900, lineHeight: 1.1, color: '#0F172A', textAlign: 'center', marginBottom: 48 }}>
    ...
    <section className="bg-[#F6FBFF]" style={{ padding: '80px 0' }}>
      <div className="max-w-[1560px] mx-auto px-8" dir={isRtl ? 'rtl' : 'ltr'}>
        <div className="rounded-lg bg-gradient-to-l from-[#2F80FF] via-[#6C4DFF] to-[#A855F7] p-12 text-white shadow-[0_30px_90px_rgba(108,77,255,0.28)] flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <Link to="/register" className="h-16 px-10 rounded-2xl bg-white text-[#6C4DFF] font-black inline-flex items-center shadow-xl whitespace-nowrap">
            {isRtl ? 'הרשמה כמועמד חדש' : 'Register as Candidate'}
          </Link>
        </div>
      </div>
    ...
    <footer className="bg-[#071124] text-white pt-16 pb-8" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-[1560px] mx-auto px-8">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-white/50">
          <div>{isRtl ? '© 2024 HeadHunter. כל הזכויות שמורות.' : '© 2024 HeadHunter. All rights reserved.'}</div>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F7FBFF] text-[#0F172A]" dir={isRtl ? 'rtl' : 'ltr'}>
      <SEOHead
        title={isRtl ? 'HeadHunter - פלטפורמת גיוס מבוססת AI' : 'HeadHunter - AI-Powered Recruitment Platform'}
        description={isRtl
        ...
        keywords={isRtl ? 'דרושים, משרות, גיוס, AI, קריירה, HeadHunter, HR-Tech' : 'jobs, recruitment, AI, career, HeadHunter, HR-Tech, Israel'}
      />
