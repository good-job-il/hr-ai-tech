...
const CITIES = ['תל אביב', 'ירושלים', 'חיפה', 'ראשון לציון', 'פתח תקווה', 'נתניה', 'באר שבע', 'הרצליה', 'כפר סבא', 'רעננה'];
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-[#1a1f35] to-background" dir="rtl">
      <SEOHead
        ...
        schemaData={{
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": `דרושים ${decodedCategory}`, "item": canonical }
          ]
        }}
      />
      <Navbar />
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg">{isLoading ? 'טוען...' : `${jobs.length} משרות פתוחות בתחום ${decodedCategory}`}</p>
        </div>
