        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-1 mt-1.5">
                {explanation.strengths.slice(0, 2).map((s, i) => (
                  <span key={i} className="text-xs bg-[#F0F9FF] text-[#0284C7] px-2 py-0.5 rounded-full font-semibold">
                    {s}
                  </span>
                ))}
              </div>
            ...
            <div className="flex flex-col items-end gap-2 flex-shrink-0">
              ...
              <ChevronRight className={`w-4 h-4 text-[#94A3B8] transition-transform ${expanded === job.id ? 'rotate-90' : ''}`} />
            </div>
          </div>
