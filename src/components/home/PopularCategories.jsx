  ...
  const CATEGORIES = [
    {
      title: "משרות יום",
      salary: "עד ₪25,000",
      count: `${dailyCount} משרות`,
      link: "/jobs?type=daily",
    },
    ...
    { title: "עבודה מהבית", count: `${remoteCount} משרות`, link: "/jobs?type=remote" },
    {
      title: "עבודה חלקית",
      salary: "עד ₪35,000",
      count: `${partCount} משרות`,
      link: "/jobs?type=part",
    },
    {
      title: "שליח",
      salary: "₪8,000 – ₪18,000",
      count: `${getCategoryCount("שליח")} משרות`,
      link: "/jobs?q=שליח",
    },
    {
      title: "נהג",
      salary: "₪10,000 – ₪22,000",
      count: `${getCategoryCount("נהג")} משרות`,
      link: "/jobs?q=נהג",
    },
    {
      title: "מוכר/ת",
      salary: "₪8,000 – ₪16,000",
      count: `${getCategoryCount("מוכר")} משרות`,
      link: "/jobs?q=מוכר",
    },
    {
      title: "קופאי/ת",
      salary: "₪8,000 – ₪14,000",
      count: `${getCategoryCount("קופאי")} משרות`,
      link: "/jobs?q=קופאי",
    },
    {
      title: "מנהל/ת",
      salary: "עד ₪40,000",
      count: `${getCategoryCount("מנהל")} משרות`,
      link: "/jobs?q=מנהל",
    },
    {
      title: "מפתח/ת תוכנה",
      salary: "₪15,000 – ₪50,000",
      count: `${getCategoryCount("מפתח")} משרות`,
      link: "/jobs?q=מפתח",
    },
    {
      title: "שיווק",
      salary: "עד ₪30,000",
      count: `${getCategoryCount("שיווק")} משרות`,
      link: "/jobs?q=שיווק",
    },
    {
      title: "מנהל/ת חשבונות",
      salary: "₪10,000 – ₪25,000",
      count: `${getCategoryCount("חשבונות")} משרות`,
      link: "/jobs?q=חשבונות",
    },
    {
      title: "מהנדס/ת",
      salary: "₪15,000 – ₪40,000",
      count: `${getCategoryCount("מהנדס")} משרות`,
      link: "/jobs?q=מהנדס",
    },
    {
      title: 'עו"ד',
      salary: "₪10,000 – ₪50,000",
      count: `${getCategoryCount("עורך דין")} משרות`,
      link: "/jobs?q=עורך דין",
    },
    {
      title: "מעצב/ת",
      salary: "עד ₪28,000",
      count: `${getCategoryCount("מעצב")} משרות`,
      link: "/jobs?q=מעצב",
    },
    {
      title: "אחות/אח",
      salary: "₪12,000 – ₪30,000",
      count: `${getCategoryCount("אחות")} משרות`,
      link: "/jobs?q=אחות",
    },
  ]
