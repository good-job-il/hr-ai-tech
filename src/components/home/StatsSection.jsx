  ...
  const STATS = [
    {
      ...
      value: `${(candidates.length || 15000).toLocaleString("he-IL")}+`,
    ...
    },
    {
      ...
      value: `${(companies.length || 1200).toLocaleString("he-IL")}+`,
      label: "חברות נגיסות",
    },
    {
      icon: Briefcase,
      ...
      value: `${(jobs.length || 8500).toLocaleString("he-IL")}+`,
      label: "משרות פתוחות",
    },
    {
      icon: Star,
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 20px 56px rgba(108,77,255,0.12)"
                }}
                onMouseLeave={(e) => {
