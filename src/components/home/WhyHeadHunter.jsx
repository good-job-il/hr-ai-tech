...
const FEATURES = [
  {
    icon: Bot, color: '#6C4DFF', bg: 'rgba(108,77,255,0.08)',
    tag: 'חדש', tagBg: 'rgba(108,77,255,0.1)', tagColor: '#6C4DFF',
  ...
  {
    icon: Bell, color: '#4F7CFF', bg: 'rgba(79,124,255,0.08)',
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: '0 32px' }}>
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          <h2 style={{
            ...
            fontWeight: 900, color: '#0F172A', margin: '0 0 14px',
          ...
          {FEATURES.map((f, i) => {
            ...
            return (
              ...
              onMouseLeave={e => {
                ...
                <h3 style={{ fontSize: 15.5, fontWeight: 800, color: '#0F172A', margin: '0 0 10px', letterSpacing: '-0.02em' }}>{f.title}</h3>
