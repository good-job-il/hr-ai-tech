  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: "hidden",
        background:
          "radial-gradient(ellipse 80% 60% at 60% -10%, rgba(108,77,255,0.18) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 0% 80%, rgba(79,124,255,0.12) 0%, transparent 60%), linear-gradient(180deg, #F8FAFF 0%, #EEF2FF 40%, #F8FAFF 100%)",
      }}
    >
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0, pointerEvents: "none" }}>
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(108,77,255,0.15) 0%, rgba(108,77,255,0.06) 35%, transparent 65%)",
            filter: "blur(40px)",
          }}
        />
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              משרות איכותיות, התאמה אישית, הליך פשוט ומהיר — כל מה שצריך כדי למצוא את העבודה הבאה
              שלך.
            </p>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 44 }}>
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 12px 36px rgba(108,77,255,0.55), 0 2px 8px rgba(108,77,255,0.25)"
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = ""
                  e.currentTarget.style.boxShadow =
                    "0 8px 28px rgba(108,77,255,0.45), 0 2px 8px rgba(108,77,255,0.2)"
                }}
              >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.color = "#6C4DFF"
          ...
          >
            ...
            <div
              style={{
                ...
                zIndex: 2,
                filter:
                  "drop-shadow(0 0 60px rgba(108,77,255,0.5)) drop-shadow(0 0 120px rgba(108,77,255,0.25))",
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  ...
                  >
                    <img
                      src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=88&h=88&fit=crop&crop=face"
                      alt=""
                      style={{ width: "100%", height: "100%", objectFit: "cover" }}
                ...
                <div style={{ textAlign: "center", flexShrink: 0 }}>
                  <div style={{ position: "relative", width: 44, height: 44 }}>
                    ...
                    >
                      <span
                        style={{ fontSize: 9.5, fontWeight: 900, color: "#6C4DFF", lineHeight: 1 }}
                      >
                        95%
                      </span>
                    </div>
              ...
              <div
                style={{
                  height: 1,
                  background:
                    "linear-gradient(90deg, transparent, rgba(108,77,255,0.12), transparent)",
                  margin: "0 0 14px",
                }}
              />
              ...
              {[
                {
                  ...
                  sub: "TalentField • תל אביב | 2023 – היום",
                },
                {
                  icon: GraduationCap,
                  color: "#4F7CFF",
                  bg: "rgba(79,124,255,0.08)",
                  title: "מדעי המחשב B.Sc",
                  sub: "אוניברסיטת תל אביב | 2021",
                },
              ].map((item, i) => {
