  ...
  return (
    ...
    >
          ...
          {!user ? (
            <>
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "rgba(108,77,255,0.06)"
      ...
      {open && (
        <div
          dir={isRtl ? "rtl" : "ltr"}
          style={{ background: "white", borderTop: "1px solid #F0F2FA", padding: "16px 24px 24px" }}
        >
          {NAV_LINKS.map((link) => (
            <Link
              key={link.label}
