    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" dir="rtl">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-1">תדירות סינכרון (שעות)</label>
            <input type="number" min="1" max="24" value={form.interval_hours} onChange={e => setForm({ ...form, interval_hours: Number(e.target.value) })}
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-hhblue/30 text-gray-900 bg-white" />
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={loading} className="flex-1 bg-hhblue text-white py-2 rounded-lg text-sm font-semibold hover:bg-hhblue/90 disabled:opacity-50">
