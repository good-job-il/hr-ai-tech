...
export default function CandidateFilters({ isOpen, onClose, filters, onFilterChange }) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 bottom-0 w-80 bg-white z-50 shadow-xl overflow-y-auto" dir="rtl">
              ...
              {expanded[section.id] && (
                <div className="border-t border-gray-100 p-3 space-y-2 bg-gray-50">
                  {section.options.map(opt => (
                    <label key={opt.value} className="flex items-center gap-2 cursor-pointer hover:bg-white p-2 rounded">
                      <input
                        type="checkbox"
