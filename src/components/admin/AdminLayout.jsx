  ...
  return (
    <div dir="rtl" className="min-h-screen flex bg-[#F5FAFF] text-[#0F172A]">
      <aside className="fixed top-0 right-0 bottom-0 z-40 w-[280px] hidden md:flex flex-col bg-white/80 backdrop-blur-2xl border-l border-[#DDEBFF] shadow-[0_30px_90px_rgba(79,124,255,0.12)]">
        <Link
          to="/"
          className="h-[96px] flex items-center justify-center px-6 border-b border-[#E4ECFF]"
        >
      ...
      <div className="flex-1 md:mr-[280px] min-h-screen flex flex-col">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <button
              className="relative w-10 h-10 lg:w-11 lg:h-11 rounded-full bg-white/90 border border-white/80 shadow-sm flex items-center justify-center transition hover:shadow-[0_0_0_3px_rgba(108,77,255,0.15)] hover:border-[#C4B5FD]"
