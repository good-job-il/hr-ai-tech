...
export default function EmployerLayout() {
  ...
  return (
    <div dir={dir} className="min-h-screen bg-[#F7FBFF] flex">
      <aside
        className={`fixed inset-y-0 z-40 w-64 bg-white flex flex-col transform transition-transform md:translate-x-0
        ${
          isEn
      ...
      <div
        className={`flex-1 min-w-0 flex flex-col min-h-screen ${isEn ? "md:ml-64" : "md:mr-64"}`}
      >
