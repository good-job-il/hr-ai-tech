...
const Card = React.forwardRef(({ className = "", variant = "elevated", ...props }, ref) => {
  const variants = {
    elevated:
      "bg-white/90 border border-blue-300/50 shadow-card hover:shadow-lg transition-all backdrop-blur-md",
    glass:
      "bg-gradient-to-br from-white/95 to-white/85 border border-blue-300/60 shadow-glass backdrop-blur-2xl",
