...
const Button = React.forwardRef(
  ({ className = "", variant = "primary", size = "md", ...props }, ref) => {
    ...
    const variants = {
      primary:
        "bg-gradient-to-r from-[#7C4DFF] to-[#4F7CFF] hover:from-[#6B3EEE] hover:to-[#4070EE] text-white shadow-xl hover:shadow-2xl",
      secondary:
        "bg-white/90 border-2 border-purple-600 text-purple-600 hover:bg-white/100 transition-all backdrop-blur-sm",
