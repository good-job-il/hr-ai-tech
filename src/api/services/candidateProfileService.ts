...
export const candidateProfileService = {
  me: () =>
    httpClient.get<CandidateProfileRecord | null>("/candidates/profiles/me", { cache: false }),
  create: (payload: CandidateProfileInput) =>
    httpClient.post<CandidateProfileRecord>("/candidates/profiles", payload),
