...
export type ApplicationSource = 'app' | 'linkedin' | 'facebook' | 'jobsite' | 'pool_assignment' | 'email_intake' | 'other';
...
export type SubmitApplicationInput = Pick<CreateApplicationInput,
  'job_id' | 'candidate_name' | 'candidate_phone' | 'resume_url' | 'resume_filename' |
  'cover_letter' | 'desired_salary_min' | 'desired_salary_max' | 'location'
>;
