...
export const compensationPlanService = new ResourceService<CompensationPlanRecord, CompensationPlanQuery, CompensationPlanInput, Partial<CompensationPlanInput>>('/compensation-plans');
